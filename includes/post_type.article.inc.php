...
/**
 * Custom Post Types (Article)
 *
**/

# Exit if accessed directly
if(!defined("ARTICLEAPP_EXEC")){
	die();
}


 /**
  * Dispaly front-end for custom post article
  * 
  * @package Article
  * @author prwirepro
  * @version 1.0
...
class Article_TheContent{
	...
	public function __construct(){
		$this->options = get_option("article_plugins"); // get current option
	...
	public function Markup($content){
		...
		$new_content .= "<div class=\"articleapp-row\">" ; 
		$new_content .= "<div class=\"articleapp-col-md-4\">" ; 
		$new_content .= "</div><!-- .//articleapp-col-md-4 -->" ; 
		$new_content .= "<div class=\"articleapp-col-md-8\">" ; 
		$new_content .= "<dl class=\"articleapp-dl-horizontal\">" ; 
		$new_content .= "<dl>" ; 
		$new_content .= "</div><!-- .//articleapp-col-md-8 -->" ; 
		$new_content .= "</div><!-- .//articleapp-row -->" ; 
		...
		$new_content .= "<div class=\"articleapp-panel articleapp-panel-default\">" ;
		$new_content .= "<div class=\"articleapp-panel-body\">" ;
		$new_content .= $content ;
		$new_content .= "</div>" ;
		$new_content .= "</div>" ;
		return $new_content;
